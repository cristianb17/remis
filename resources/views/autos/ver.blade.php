 ...
 <form method="GET" action="{{ route('listarAutos') }}">
	...
	<div style="border-style: solid; font-size: 16px" >
    	<div class="form-group row">
    		...
    		<div class="col-md-4">
    			...
    			<div class="col-8">
    				<input class="form-control" disabled type="text" value="{{$auto->marca}}">
    			</div>
    		</div>
    		<div class="col-md-4">
    			<label for="example-text-input" class="col-2 col-form-label">Modelo</label>
    			<div class="col-8">
    				<input class="form-control" disabled type="text" value="{{$auto->modelo}}">
    			</div>
    		</div>
    	</div>
    	...
    	<div class="form-group row">
    		<div class="col-md-4">
    			...
    			<div class="col-8">
    				<input class="form-control" disabled type="number" value="{{$auto->ano}}">
    			</div>
    		</div>
    		<div class="col-md-4">
    			<label for="example-text-input" class="col-2 col-form-label">Color</label>
    			<div class="col-8">
    				<input class="form-control" disabled type="text" value="{{$auto->color}}">
    			</div>
    		</div>
    		<div class="col-md-4">
    			<label for="example-text-input" class="col-2 col-form-label">Patente</label>
    			<div class="col-8">
    				<input class="form-control" disabled type="text" value="{{$auto->patente}}">
    			</div>
    		</div>
    	</div>
	...
	<div style="border-style: solid;font-size: 16px">
	  <div class="form-group row">
		<div class="col-md-4">
			...
			<div class="col-8">
				<input class="form-control" disabled type="text" value="{{$auto->propietario}}">
			</div>
		</div>
		...
		<div class="col-md-4">
			...
			<div class="col-8">
				<input class="form-control" disabled type="text" value="{{$auto->domicilio}}">
			</div>
		</div>
		...
		<div class="col-md-4">
			...
			<div class="col-8">
				<input class="form-control" disabled type="text" value="{{$auto->localidad}}">
			</div>
		</div>
	</div>
	...
	<div class="form-group row">
		<div class="col-md-4">
			...
			<div class="col-8">
				<input class="form-control" disabled type="tel" value="{{$auto->tel1}}">
			</div>
		</div>
		...
		<div class="col-md-4">
			...
			<div class="col-8">
				<input class="form-control" disabled type="tel" value="{{$auto->tel2}}">
			</div>
		</div>
	</div>
</div>
	...
	<div class="form-group row">
		<div class="col-md-4">
			...
			<div class="col-8">
				<input class="form-control" disabled type="date" value="{{$auto->altaAgencia}}">
			</div>
		</div>
		...
		<div class="col-md-4">
			...
			<div class="col-8">
				<input class="form-control" disabled type="date" value="{{$auto->vencPoliza}}">
			</div>
		</div>
	...
	<div class="col-md-4">
			...
			<div class="col-8">
				<input class="form-control" disabled type="date" value="{{$auto->vencGNC}}">
			</div>
		</div>
	...
	<div class="form-group row">
		<div class="col-md-6">
			...
			<div class="col-7">
				<input class="form-control"  disabled type="date" name="vencPagoSeg" value="{{$auto->vencPagoSeg}}">
			</div>
		</div>
		...
		<div class="col-md-6">
			...
			<div class="col-7">
				<input class="form-control"  disabled type="date" name="vencHabAuto" value="{{$auto->vencHabAuto}}">
			</div>
		</div>
	...
	<div class="form-group row">
		<div class="col-md-6">
			<label for="example-text-input" class="col-5 col-form-label">Odómetro</label>
				<select name="odometroDatosFac" disabled>
		...
		<div class="col-md-6">
			<label for="example-text-input" class="col-4 col-form-label">Radio</label>
				<select name="radioDatosFact" disabled>
	...
	<div class="form-group row">
		...
		<div class="col-md-6">
			<label for="example-text-input" class="col-4 col-form-label">Prevision de Multas</label>
				<select name="previsionMultas" disabled>
