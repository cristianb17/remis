...
<div class="container">
	...
	<div class="form-group row">
       ...
       <form method="POST" action="{{ route('listarReservas') }}">
                        @csrf
...
<div style="border-style: solid;">
	<div class="form-group row">
		<div class="col-md-6">
			...
			<div class="col-7">
				<input class="form-control" type="text" name="diaHoraViaje"  disabled value="{{$reserva->diaHoraViaje}}">
			</div>
		</div>
		<div class="col-md-6">
			<label for="example-text-input" class="col-5 col-form-label"><strong>Aviso al Despachador</strong></label>
			<div class="col-7">
				<input class="form-control" type="text" name="avisoDespachador" disabled value="{{$reserva->avisoDespachador}}">
			</div>
		</div>
	</div>
	...
	<div class="form-group row">
		...
		<div class="col-md-6">
			...
			<div class="col-7">
				<input class="form-control" type="text"  name="numero" disabled value="{{$reserva->numero}}">
			</div>
		</div>
		<div class="col-md-6">
			<label for="example-email-input" class="col-5 col-form-label"><strong>Piso</strong></label>
			<div class="col-7">
				<input class="form-control" type="text" name="piso" disabled value="{{$reserva->piso}}">
			</div>
		</div>
	</div>
	<div class="form-group row">
		<div class="col-md-6">
			...
			<div class="col-7">
				<input class="form-control" type="text" name="depto" disabled value="{{$reserva->depto}}">
			</div>
		</div>
	</div>
</div>
...
<div style="border-style: solid;">
	<div class="form-group row">
		<div class="col-md-6">
			...
			<div class="col-7">
				<input class="form-control" type="text" name="precioEstimado" disabled value="{{$reserva->precioEstimado}}">
			</div>
		</div>
			<div class="col-md-6">
		...
		<div class="col-md-12">
			<div class="col-9">
                <div class="form-group">
                  ...
                  <textarea class="form-control" rows="3" id="observaciones" name="observaciones" disabled value="{{$reserva->observaciones}}"></textarea>
                </div>			
